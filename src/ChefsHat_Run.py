...
def main():
    ...
    st.markdown(
        ...
        **👈 Select one of the tools on the sidebar** and have fun!
        ...
        - Check the Chef`s Hat Gym page for an overview of the simulator: https://github.com/pablovin/ChefsHatGYM 
        - The Chef`s Hat Players Club has all the information about the artificial Players: https://github.com/pablovin/ChefsHatPlayersClub
        - And of course, check all all about the Chef`s Hat Run: https://github.com/pablovin/Chefshat_Run        
    """
    )
